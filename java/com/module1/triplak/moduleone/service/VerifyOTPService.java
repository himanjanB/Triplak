...
import com.module1.triplak.moduleone.activity.AccessContacts;
...
public class VerifyOTPService extends IntentService {
    ...
    private static String TAG = VerifyOTPService.class.getSimpleName();
    ...
    private void verifyOtp(final String otp) {
        Log.i(TAG, "In the Verify OTP class");
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    Log.i(TAG, "In the Verify OTP class. Try block");
                    ...
                    if (!error) {
                        ...
                        Log.i(TAG, "In the Verify OTP class. No error");
                        ...
                        Intent intent = new Intent(VerifyOTPService.this, AccessContacts.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(intent);

                        pref.setSuccessfulRegistration(false);

                        Toast.makeText(getApplicationContext(), message, Toast.LENGTH_LONG).show();

                    } else {
                        Log.i(TAG, "In the Verify OTP class. Some error");
                        Toast.makeText(getApplicationContext(), message, Toast.LENGTH_LONG).show();
                    }
